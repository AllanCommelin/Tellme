...
const staticAssets = [
    '/',
    '/www/css/tellme.css',
    '/www/img/icons/icon-72x72.png',
    '/www/img/icons/icon-96x96.png',
    '/www/img/icons/icon-128x128.png',
    '/www/img/icons/icon-144x144.png',
    '/www/img/icons/icon-152x152.png',
    '/www/img/icons/icon-192x192.png',
    '/www/img/icons/icon-384x384.png',
    '/www/img/icons/icon-512x512.png',
    '/www/index.ejs',
    '/www/profile.ejs',
    '/www/room.ejs',
    '/www/auth/login.ejs',
    '/www/auth/register.ejs',
    '/www/js/app.js',
    '/www/js/chat.js',
    '/www/js/main.js',
];
